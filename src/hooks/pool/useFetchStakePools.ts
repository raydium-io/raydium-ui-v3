...
const fetcher = (url: string) => axios.get<ApiV3PageIns<ApiStakePool>>(url, { skipError: true })

export default function useFetchStakePools(props: { shouldFetch?: boolean; refreshInterval?: number } & FetchPoolParams) {
