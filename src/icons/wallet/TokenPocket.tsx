...
export default function TokenPocket(props: SvgIcon) {
  return (
    <svg width="64" height="64" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <mask id="mask0_408_225" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="1024" height="1024">
