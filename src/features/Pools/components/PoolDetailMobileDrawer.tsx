            ...
            <ContentCard>
              <HStack justify={'space-between'}>
                <Flex direction="column" gap={2}>
                  ...
                  <Text textAlign={'start'}>{toUsdVolume(volume)}</Text>
                </Flex>
                <Flex direction="column" gap={2}>
                  <Text fontSize="sm" color={colors.textSecondary}>
                    {t(`field.${timeBase}_fees`)}
                  </Text>
                  <Text textAlign={'start'}>{toUsdVolume(fees)}</Text>
                </Flex>
                <Flex direction="column" gap={2}>
                  <Text fontSize="sm" color={colors.textSecondary}>
                    {t('common.tvl')}
                  </Text>
                  <Text textAlign={'start'}>{toUsdVolume(tvl)}</Text>
                </Flex>
              </HStack>
            </ContentCard>
            <ContentCard>
            ...
            <ContentCard>
              ...
              <SimpleGrid templateColumns={'repeat(2, 1fr)'} columnGap={2}>
                {weeklyRewards.map((reward) => (
                  <Flex w="full" key={String(reward.token?.address)} justify={'space-between'} align="center" fontSize="12px" mt="8px">
